...
public:
  ...
  covar(const char *outfiles,argStruct *arguments);
...
void covar::getOptions(argStruct *arguments){
...
void covar::printArg(FILE *fp){


}

covar::covar(const char *outfiles,argStruct *arguments){
