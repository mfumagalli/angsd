...
#pragma once
#include "faidx.h"
#include "general.h"//ONLY USED for reference stuff in mpileup output.
...
char *loadChr(perFasta *f,const char*chrName);



class getFasta : public general{
  char *ancName;
  char *refName;
